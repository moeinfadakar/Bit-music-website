...
$french_artists = $db->query("SELECT * FROM artists WHERE lan = 3  ");
...
<?php foreach($french_artists as $french_artist) :  ?>
      <div class="col">
      <div class="p-3">
  <div class="col">
    <div class="card h-100">
      <img src="<?php echo $french_artist["pic"]; ?> " class="card-img-top" alt="<?php echo $french_artist["name"]; ?>">
      <div class="card-body">
        <h5 class="card-title"><?php echo $french_artist["name"] ?></h5>
        
      </div>
      <div class="card-footer">
        <small class="text-body-secondary"> <?php echo $french_artist["time"]; ?>  </small>
      </div>
    </div>
  </div>
      </div>
