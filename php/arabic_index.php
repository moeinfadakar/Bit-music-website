...
$arabic_artists = $db->query("SELECT * FROM artists WHERE lan = 6");
...
<?php foreach($arabic_artists as $arabic_artist) :  ?>
    ...
    <div class="card h-100">
      <img src="<?php echo $arabic_artist["pic"]; ?> " class="card-img-top" alt="<?php echo $arabic_artist["name"]; ?>">
      <div class="card-body">
        <h5 class="card-title"><?php echo $arabic_artist["name"] ?></h5>
        
      </div>
      <div class="card-footer">
        <small class="text-body-secondary"> <?php echo $arabic_artist["time"]; ?>  </small>
      </div>
    </div>
  </div>
