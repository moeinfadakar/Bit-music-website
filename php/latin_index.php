...
$latin_artists = $db->query("SELECT * FROM artists WHERE lan = 5 ");
...
<?php foreach($latin_artists as $latin_artist) :  ?>

    <div class="col">
      <div class="p-3">
      <div class="col">
    <div class="card h-100">
      <img src="<?php echo $latin_artist["pic"]; ?> " class="card-img-top" alt="<?php echo $latin_artist["name"]; ?>">
      <div class="card-body">
        <h5 class="card-title"><?php echo $latin_artist["name"] ?></h5>
        
      </div>
      <div class="card-footer">
        <small class="text-body-secondary"> <?php echo $latin_artist["time"]; ?>  </small>
      </div>
    </div>
  </div>
