...
$Russian_artists  = $db->query("SELECT * FROM artists WHERE lan = 4 ");
...
<div id="carouselExampleCaptions" class="carousel slide end">
  ...
  <div class="carousel-inner end">
    ...
    <div class="carousel-item">
      <img src="motamedi.jpg" class="d-block  ax rad" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h3>محمد معتمدی</h3>
        <p>تازه ترین های محمد معتمدی </p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="aghili.webp" class="d-block  ax rad" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h3>سالار عقیلی</h3>
        <p>تازه ترین های سالار عقیلی</p>
      </div>
    </div>
  </div>
...
<?php foreach($Russian_artists as $Russian_artist) :  ?>

    <div class="col">
      <div class="p-3">
      <div class="col">
    <div class="card h-100">
      <img src="<?php echo $Russian_artist["pic"]; ?> " class="card-img-top" alt="<?php echo $Russian_artist["name"]; ?>">
      <div class="card-body">
        <h5 class="card-title"><?php echo $Russian_artist["name"] ?></h5>
        
      </div>
      <div class="card-footer">
        <small class="text-body-secondary"> <?php echo $Russian_artist["time"]; ?>  </small>
      </div>
    </div>
  </div>
